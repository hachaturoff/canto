const fonts = {
	...
	bullish: {
		glyphMSDFURL: "assets/bullshit_msdf.png",
		glyphSequenceLength: 17,
		glyphTextureGridSize: [5, 5],
	},
	bullish_spaces: {
		glyphMSDFURL: "assets/bullshit_spaces_msdf.png",
		glyphSequenceLength: 20,
		glyphTextureGridSize: [5, 5],
	},
	bullish_spaces_2: {
		glyphMSDFURL: "assets/bullshit_spaces_2_msdf.png",
		glyphSequenceLength: 20,
		glyphTextureGridSize: [5, 5],
	},
	bullish_doge: {
		glyphMSDFURL: "assets/doge_msdf.png",
		glyphSequenceLength: 19,
		glyphTextureGridSize: [5, 5],
	},
	huberfishA: {
...
const versions = {
	...
	bullish_spaces: {
		...
		baseTexture: "pixels",
		glyphEdgeCrop: 0,
		cursorColor: rgb(0.95, 0.66, 0),
		cursorIntensity: 1.5,
		isolateGlint: true,
		glintColor: rgb(0, 0, 0),
		glintIntensity: 3,
		glintBrightness: -0.5,
		glintContrast: 1.5,
		baseBrightness: -0.4,
